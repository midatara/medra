function initColumnResizing() {
    const table = document.querySelector('.generales-table');
    if (!table) return;
    ...
    const saved = localStorage.getItem('generales-column-widths');
    if (saved) {
        try {
    ...
    function saveColumnWidths() {
        ...
        localStorage.setItem('generales-column-widths', JSON.stringify(widths));
    }

    // Reaplicar al cambiar filas
